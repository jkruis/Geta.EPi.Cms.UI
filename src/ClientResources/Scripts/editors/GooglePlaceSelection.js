...
function (
    ...
    return declare("geta-epi-cms.editors.GooglePlaceSelection", [_Widget, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        initializeMap: function () {
            ...
            delete (this.map);
            delete (this.placesAutoComplete);
        ...
        hookupEvents: function () {
            ...
            //this.lat.on("change", lang.hitch(this, this.onLatLonChanged));
            //this.lon.on("change", lang.hitch(this, this.onLatLonChanged));
        },
